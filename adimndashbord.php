        ...
        <nav class="navbar navbar-expand-md navbar-dark">
          ...
          <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item">
                <a href="dashboard.php" class="nav-link link-active">Contacts 
                    <sup class='bg-danger' style="font-size:20px; font-weight:bold; border-radius:50%; padding:1px 0px 1px 0px;">
<?php if($cNn!=0){echo $cNn;}?>
</sup>
                </a>
              </li>
