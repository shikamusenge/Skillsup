...
<html lang="en">
  ...
  <body>
    ...
    <div class="px-5 row">
      ...
      <div class="main-section col-sm-12 col-lg-5 col-md-5">
        <h4>Update Your Profile</h4>
        <div class="profile">
          <img src="image/logo.svg" alt="Image Not found" class="ifoto">
          <label for="uploading" class="Uploadimage"> Photo</label>
          <input type="file" class="file" id="uploading">
        </div>
      </div>
