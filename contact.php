...
<html lang="en">
  ...
  <body>
        ...
        <nav class="navbar navbar-expand-md navbar-dark">
          ...
          <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item">
                <a href="contact.php" class="nav-link link-active"
                  >Contact Us</a
                >
              </li>
              <li class="nav-item">
    ...
    <div class="px-5 row">
      <div class="side-bar col-sm-12 col-md-12 col-lg-3">
      ...
      <!-- End of side bar -->
      <div class="main-section col-sm-12 col-lg-5 col-md-12">
        <form action="app.php" method ="post" class="p-5 form-signup">
          <h3 class="text-center">Contact Us</h3>
          <?php if(isset($_GET['Msg'])){echo "<div class='Msg text-success text-center'> $_GET[Msg]</div>";} ?>
          <label class="label-check" for="userName"> Full Names</label>
          <input type="text" class="form-control" id="userName" name="names" required/>

          <label class="label-check" for="email">Email address</label>
          <input type="email" class="form-control" id="email" name="email"/>

          <label class="label-check" for="telephone"> Telephone</label>
          <input type="text" class="form-control" id="telephone" name="phone"/>

          <label class="label-check" for="message">Send your message</label>
          <textarea
            id="message"
            cols="30"
            rows="5"
          ...
          <button class="btn btn-outline-primary" name="contactMessageBtn">submit</button>
          <button class="btn btn-outline-primary" type="reset">Cancel</button>
        </form>
      </div>
      <div class="contant col-md-12 col-lg-4 col-sm-12">
        <h3>Our contact Us on</h3>
        <hr />
        Telephone: +250787647168 +250784589448
      </div>
      <!-- End of main section -->
    </div>
    ...
    <div class="footer row bg-primary px-5 text-light">
      ...
      <div class="col-md-12 col-lg-4 col-sm-12">
        ...
        Email: <a href="">shikamusengeelisa777@gmail.com</a>
        <br />
        Telephone: +250
      </div>
